...
class Hangman():
   def __init__(self):
       ...
       if user_choice_1 == '1':
           print("\nStatus [34%] Loading system files, please wait...")
           time.sleep(1.5)
           print("Status [78%] Loading language package files, please wait...")
           time.sleep(1.5)
           print("Status [99%] Finalizing, please wait...")
           time.sleep(2)
           os.system('clear')
           self.start_game()
   ...
   def core_game(self):
       ...
       while guesses < 6:
           ...
           if guess in the_word and guess not in letters_used:
               ...
               if self.progress_updater(guess, the_word, progress) == the_word:
